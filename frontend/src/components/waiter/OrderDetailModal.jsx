...
const OrderDetailModal = ({ order, onClose }) => {
    ...
    const handlePrint = () => {
        ...
        iframeDoc.open();
        iframeDoc.write('<html><head><title>Print Invoice</title>');
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col animate-scale-in">
                ...
                <div className="p-5 border-b flex justify-between items-center bg-gray-50">
                    <h3 className="text-xl font-extrabold text-gray-800">Order Details</h3>
                ...
                <div className="p-6 overflow-y-auto flex-1">
                    ...
                    <div id="invoice-preview" className="border border-gray-100 p-4 rounded-xl bg-gray-50/50">
                        <div className="text-center mb-6">
                            ...
                            <h3 className="text-lg font-bold">PROVISIONAL INVOICE</h3>
                            <p className="text-xs text-gray-500">Ord ID: #{order.id.slice(0, 8)}</p>
                        ...
                        <div className="mb-4">
                            ...
                            {order.customer && <p><strong>Customer:</strong> {order.customer.full_name}</p>}
                        </div>
